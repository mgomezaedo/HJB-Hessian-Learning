%MAIN_REGRESS  Entry point: fit the 6-D satellite value function, report error.
%   Loads the datasets produced by generation/rigidbody_6d, builds the chosen
...
% ============================ CONFIG ============================
% Folder with the .mat datasets written by generation/rigidbody_6d:
data_dir = fullfile(here, '..', '..', 'generation', 'rigidbody_6d', 'data');
train_file = 'train_rb6d.mat';
val_file   = 'val_rb6d.mat';

% --- basis choice ---
basis_type = 'enriched';   % 'HC' = hyperbolic cross, 'enriched' = HC + total-degree
hc_level   = 4;      % HC level
...
% save(fullfile(here,'coeffs_rb6d.mat'), 'theta', 'NN', 'a_vec', 'ord', 'basis_type');
